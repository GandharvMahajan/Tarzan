...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/src/install/oradar_lidar"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/oradar_lidar/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/oradar_lidar/environment/path.sh"
