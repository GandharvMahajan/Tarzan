...
class Metaclass_MotorsState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from msgs_srvs.msg import MotorState
...
class MotorsState(metaclass=Metaclass_MotorsState):
    ...
    _fields_and_field_types = {
        'data': 'sequence<msgs_srvs/MotorState>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['msgs_srvs', 'msg'], 'MotorState')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'data' field must be a set or sequence and each value of type 'MotorState'"
        self._data = value
