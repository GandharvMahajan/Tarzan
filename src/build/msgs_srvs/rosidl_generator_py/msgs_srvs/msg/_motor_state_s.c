...
bool msgs_srvs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_srvs.msg._motor_state.MotorState", full_classname_dest, 37) == 0);
  }
  msgs_srvs__msg__MotorState * ros_message = _ros_message;
  {  // id
...
PyObject * msgs_srvs__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_srvs.msg._motor_state");
