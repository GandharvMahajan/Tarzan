...
#include "msgs_srvs/msg/detail/pwm_servo_state_duration__rosidl_typesupport_fastrtps_c.h"
...
using _PWMServoStateDuration__ros_msg_type = msgs_srvs__msg__PWMServoStateDuration;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PWMServoStateDuration__ros_msg_type * ros_message = static_cast<const _PWMServoStateDuration__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PWMServoStateDuration__ros_msg_type * ros_message = static_cast<_PWMServoStateDuration__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_msgs_srvs__msg__PWMServoStateDuration(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PWMServoStateDuration__ros_msg_type * ros_message = static_cast<const _PWMServoStateDuration__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PWMServoStateDuration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_srvs__msg__PWMServoStateDuration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_srvs
size_t max_serialized_size_msgs_srvs__msg__PWMServoStateDuration(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs__msg__PWMServoStateDuration;
    is_plain =
      (
...
static size_t _PWMServoStateDuration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_srvs__msg__PWMServoStateDuration(
...
static message_type_support_callbacks_t __callbacks_PWMServoStateDuration = {
  "msgs_srvs::msg",
...
static rosidl_message_type_support_t _PWMServoStateDuration__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PWMServoStateDuration,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_srvs, msg, PWMServoStateDuration)() {
  return &_PWMServoStateDuration__type_support;
}
