...
#include "msgs_srvs/msg/detail/buzzer_state__rosidl_typesupport_fastrtps_c.h"
...
using _BuzzerState__ros_msg_type = msgs_srvs__msg__BuzzerState;
  ...
  void * untyped_ros_message)
{
  ...
  _BuzzerState__ros_msg_type * ros_message = static_cast<_BuzzerState__ros_msg_type *>(untyped_ros_message);
  // Field name: freq
  {
    cdr >> ros_message->freq;
  }
...
size_t get_serialized_size_msgs_srvs__msg__BuzzerState(
  const void * untyped_ros_message,
...
static uint32_t _BuzzerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_srvs__msg__BuzzerState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_srvs
size_t max_serialized_size_msgs_srvs__msg__BuzzerState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs__msg__BuzzerState;
    is_plain =
      (
...
static size_t _BuzzerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_srvs__msg__BuzzerState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_srvs, msg, BuzzerState)() {
