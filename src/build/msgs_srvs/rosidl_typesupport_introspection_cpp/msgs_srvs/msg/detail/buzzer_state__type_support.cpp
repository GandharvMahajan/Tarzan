...
{
  new (message_memory) msgs_srvs::msg::BuzzerState(_init);
}

void BuzzerState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgs_srvs::msg::BuzzerState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BuzzerState_message_member_array[4] = {
  {
    ...
    offsetof(msgs_srvs::msg::BuzzerState, freq),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_srvs::msg::BuzzerState, on_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_srvs::msg::BuzzerState, off_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msgs_srvs::msg::BuzzerState, repeat),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BuzzerState_message_members = {
  ...
  4,  // number of fields
  sizeof(msgs_srvs::msg::BuzzerState),
...
{
  return &::msgs_srvs::msg::rosidl_typesupport_introspection_cpp::BuzzerState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_srvs, msg, BuzzerState)() {
  return &::msgs_srvs::msg::rosidl_typesupport_introspection_cpp::BuzzerState_message_type_support_handle;
}
