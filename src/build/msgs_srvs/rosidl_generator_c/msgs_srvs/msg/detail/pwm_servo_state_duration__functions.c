...
msgs_srvs__msg__PWMServoStateDuration__init(msgs_srvs__msg__PWMServoStateDuration * msg)
{
  ...
  if (!msgs_srvs__msg__PWMServoState__Sequence__init(&msg->state, 0)) {
    msgs_srvs__msg__PWMServoStateDuration__fini(msg);
    return false;
  }
  // duration
  return true;
...
msgs_srvs__msg__PWMServoStateDuration__create()
{
  ...
  msgs_srvs__msg__PWMServoStateDuration * msg = (msgs_srvs__msg__PWMServoStateDuration *)allocator.allocate(sizeof(msgs_srvs__msg__PWMServoStateDuration), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msgs_srvs__msg__PWMServoStateDuration));
  bool success = msgs_srvs__msg__PWMServoStateDuration__init(msg);
  if (!success) {
...
msgs_srvs__msg__PWMServoStateDuration__Sequence__init(msgs_srvs__msg__PWMServoStateDuration__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__msg__PWMServoStateDuration * data = NULL;

  if (size) {
    data = (msgs_srvs__msg__PWMServoStateDuration *)allocator.zero_allocate(size, sizeof(msgs_srvs__msg__PWMServoStateDuration), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msgs_srvs__msg__PWMServoStateDuration__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msgs_srvs__msg__PWMServoStateDuration__fini(&data[i - 1]);
      }
...
msgs_srvs__msg__PWMServoStateDuration__Sequence__fini(msgs_srvs__msg__PWMServoStateDuration__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msgs_srvs__msg__PWMServoStateDuration__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__msg__PWMServoStateDuration__Sequence * array = (msgs_srvs__msg__PWMServoStateDuration__Sequence *)allocator.allocate(sizeof(msgs_srvs__msg__PWMServoStateDuration__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msgs_srvs__msg__PWMServoStateDuration__Sequence__init(array, size);
  if (!success) {
...
msgs_srvs__msg__PWMServoStateDuration__Sequence__destroy(msgs_srvs__msg__PWMServoStateDuration__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msgs_srvs__msg__PWMServoStateDuration__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msgs_srvs__msg__PWMServoStateDuration__Sequence__are_equal(const msgs_srvs__msg__PWMServoStateDuration__Sequence * lhs, const msgs_srvs__msg__PWMServoStateDuration__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msgs_srvs__msg__PWMServoStateDuration__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msgs_srvs__msg__PWMServoStateDuration__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msgs_srvs__msg__PWMServoStateDuration);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msgs_srvs__msg__PWMServoStateDuration * data =
      (msgs_srvs__msg__PWMServoStateDuration *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msgs_srvs__msg__PWMServoStateDuration__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msgs_srvs__msg__PWMServoStateDuration__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msgs_srvs__msg__PWMServoStateDuration__copy(
