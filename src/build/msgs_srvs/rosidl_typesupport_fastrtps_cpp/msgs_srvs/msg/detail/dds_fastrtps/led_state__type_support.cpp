...
#include "msgs_srvs/msg/detail/led_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msgs_srvs::msg::LedState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs_srvs::msg::LedState & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs::msg::LedState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_srvs::msg::LedState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_srvs::msg::LedState *>(
    untyped_ros_message);
...
{
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_LedState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_srvs, msg, LedState)() {
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_LedState__handle;
}
