...
#include "msgs_srvs/msg/detail/pwm_servo_state__rosidl_typesupport_fastrtps_c.h"
...
using _PWMServoState__ros_msg_type = msgs_srvs__msg__PWMServoState;
...
static uint32_t _PWMServoState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_srvs__msg__PWMServoState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs__msg__PWMServoState;
    is_plain =
      (
...
static size_t _PWMServoState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_srvs__msg__PWMServoState(
