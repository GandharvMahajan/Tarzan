...
#include "msgs_srvs/msg/detail/led_state__rosidl_typesupport_fastrtps_c.h"
...
using _LedState__ros_msg_type = msgs_srvs__msg__LedState;
...
size_t get_serialized_size_msgs_srvs__msg__LedState(
  const void * untyped_ros_message,
...
static uint32_t _LedState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs_srvs__msg__LedState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs_srvs
size_t max_serialized_size_msgs_srvs__msg__LedState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs__msg__LedState;
    is_plain =
      (
...
static size_t _LedState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs_srvs__msg__LedState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs_srvs, msg, LedState)() {
