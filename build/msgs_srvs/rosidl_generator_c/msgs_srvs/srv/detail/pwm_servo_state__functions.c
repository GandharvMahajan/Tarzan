...
msgs_srvs__srv__PWMServoState_Request__init(msgs_srvs__srv__PWMServoState_Request * msg)
{
  ...
  // cmd
  if (!msgs_srvs__msg__PWMServoState__Sequence__init(&msg->cmd, 0)) {
    msgs_srvs__srv__PWMServoState_Request__fini(msg);
    return false;
  }
  return true;
}
...
msgs_srvs__srv__PWMServoState_Request__fini(msgs_srvs__srv__PWMServoState_Request * msg)
{
  ...
  // cmd
  msgs_srvs__msg__PWMServoState__Sequence__fini(&msg->cmd);
}
...
msgs_srvs__srv__PWMServoState_Request__are_equal(const msgs_srvs__srv__PWMServoState_Request * lhs, const msgs_srvs__srv__PWMServoState_Request * rhs)
{
  ...
  // cmd
  if (!msgs_srvs__msg__PWMServoState__Sequence__are_equal(
      &(lhs->cmd), &(rhs->cmd)))
  {
    return false;
  }
  ...
  msgs_srvs__srv__PWMServoState_Request * output)
{
  ...
  // cmd
  if (!msgs_srvs__msg__PWMServoState__Sequence__copy(
...
msgs_srvs__srv__PWMServoState_Request__create()
{
  ...
  msgs_srvs__srv__PWMServoState_Request * msg = (msgs_srvs__srv__PWMServoState_Request *)allocator.allocate(sizeof(msgs_srvs__srv__PWMServoState_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msgs_srvs__srv__PWMServoState_Request));
  bool success = msgs_srvs__srv__PWMServoState_Request__init(msg);
  if (!success) {
...
msgs_srvs__srv__PWMServoState_Request__Sequence__init(msgs_srvs__srv__PWMServoState_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__srv__PWMServoState_Request * data = NULL;

  if (size) {
    data = (msgs_srvs__srv__PWMServoState_Request *)allocator.zero_allocate(size, sizeof(msgs_srvs__srv__PWMServoState_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msgs_srvs__srv__PWMServoState_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msgs_srvs__srv__PWMServoState_Request__fini(&data[i - 1]);
      }
...
msgs_srvs__srv__PWMServoState_Request__Sequence__fini(msgs_srvs__srv__PWMServoState_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msgs_srvs__srv__PWMServoState_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__srv__PWMServoState_Request__Sequence * array = (msgs_srvs__srv__PWMServoState_Request__Sequence *)allocator.allocate(sizeof(msgs_srvs__srv__PWMServoState_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msgs_srvs__srv__PWMServoState_Request__Sequence__init(array, size);
  if (!success) {
...
msgs_srvs__srv__PWMServoState_Request__Sequence__destroy(msgs_srvs__srv__PWMServoState_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msgs_srvs__srv__PWMServoState_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msgs_srvs__srv__PWMServoState_Request__Sequence__are_equal(const msgs_srvs__srv__PWMServoState_Request__Sequence * lhs, const msgs_srvs__srv__PWMServoState_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msgs_srvs__srv__PWMServoState_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msgs_srvs__srv__PWMServoState_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msgs_srvs__srv__PWMServoState_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msgs_srvs__srv__PWMServoState_Request * data =
      (msgs_srvs__srv__PWMServoState_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msgs_srvs__srv__PWMServoState_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msgs_srvs__srv__PWMServoState_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msgs_srvs__srv__PWMServoState_Request__copy(
...
msgs_srvs__srv__PWMServoState_Response__init(msgs_srvs__srv__PWMServoState_Response * msg)
{
  ...
  // success
  // state
  if (!msgs_srvs__msg__PWMServoState__Sequence__init(&msg->state, 0)) {
    msgs_srvs__srv__PWMServoState_Response__fini(msg);
    return false;
  }
  return true;
}
...
msgs_srvs__srv__PWMServoState_Response__fini(msgs_srvs__srv__PWMServoState_Response * msg)
{
  ...
  // success
  // state
  msgs_srvs__msg__PWMServoState__Sequence__fini(&msg->state);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__srv__PWMServoState_Response * msg = (msgs_srvs__srv__PWMServoState_Response *)allocator.allocate(sizeof(msgs_srvs__srv__PWMServoState_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msgs_srvs__srv__PWMServoState_Response));
  bool success = msgs_srvs__srv__PWMServoState_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
msgs_srvs__srv__PWMServoState_Response__Sequence__init(msgs_srvs__srv__PWMServoState_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__srv__PWMServoState_Response * data = NULL;

  if (size) {
    data = (msgs_srvs__srv__PWMServoState_Response *)allocator.zero_allocate(size, sizeof(msgs_srvs__srv__PWMServoState_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msgs_srvs__srv__PWMServoState_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        msgs_srvs__srv__PWMServoState_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
msgs_srvs__srv__PWMServoState_Response__Sequence__fini(msgs_srvs__srv__PWMServoState_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      msgs_srvs__srv__PWMServoState_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msgs_srvs__srv__PWMServoState_Response__Sequence * array = (msgs_srvs__srv__PWMServoState_Response__Sequence *)allocator.allocate(sizeof(msgs_srvs__srv__PWMServoState_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msgs_srvs__srv__PWMServoState_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
msgs_srvs__srv__PWMServoState_Response__Sequence__destroy(msgs_srvs__srv__PWMServoState_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msgs_srvs__srv__PWMServoState_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msgs_srvs__srv__PWMServoState_Response__Sequence__are_equal(const msgs_srvs__srv__PWMServoState_Response__Sequence * lhs, const msgs_srvs__srv__PWMServoState_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msgs_srvs__srv__PWMServoState_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msgs_srvs__srv__PWMServoState_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msgs_srvs__srv__PWMServoState_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msgs_srvs__srv__PWMServoState_Response * data =
      (msgs_srvs__srv__PWMServoState_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msgs_srvs__srv__PWMServoState_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msgs_srvs__srv__PWMServoState_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!msgs_srvs__srv__PWMServoState_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
