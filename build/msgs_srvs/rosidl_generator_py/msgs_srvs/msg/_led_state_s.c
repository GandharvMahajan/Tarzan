...
bool msgs_srvs__msg__led_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_srvs.msg._led_state.LedState", full_classname_dest, 33) == 0);
  }
  msgs_srvs__msg__LedState * ros_message = _ros_message;
  {  // id
...
PyObject * msgs_srvs__msg__led_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_srvs.msg._led_state");
