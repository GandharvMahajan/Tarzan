...
#include "msgs_srvs/msg/detail/sbus__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs::msg::Sbus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_srvs::msg::Sbus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_srvs::msg::Sbus *>(
    untyped_ros_message);
...
{
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_Sbus__handle;
}
