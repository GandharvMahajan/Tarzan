...
#include "msgs_srvs/msg/detail/motors_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const msgs_srvs::msg::MotorState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  msgs_srvs::msg::MotorState &);
...
cdr_serialize(
  const msgs_srvs::msg::MotorsState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs_srvs::msg::MotorsState & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        msgs_srvs::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorState(
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs::msg::MotorsState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_srvs::msg::MotorsState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_srvs::msg::MotorsState *>(
    untyped_ros_message);
...
{
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_MotorsState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_srvs, msg, MotorsState)() {
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_MotorsState__handle;
}
