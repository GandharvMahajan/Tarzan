...
#include "msgs_srvs/msg/detail/motor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msgs_srvs::msg::MotorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs_srvs::msg::MotorState & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_srvs::msg::MotorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_srvs::msg::MotorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_srvs::msg::MotorState *>(
    untyped_ros_message);
...
{
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_srvs, msg, MotorState)() {
  return &msgs_srvs::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
